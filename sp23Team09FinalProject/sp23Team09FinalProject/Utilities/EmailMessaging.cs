...
namespace sp23Team09FinalProject.Utilities
{
    public static class EmailMessaging
    {
        public static void SendEmail(String emailSubject, String emailBody)
        {
            ...
            String strFromEmailAddress = "sp23mis333k.group9@gmail.com";
            ...
            String strPassword = "ekzckdxdlhwqrzhj";

            //This is the name of the business from which you are sending
            String strCompanyName = "MIS333K Final Project";
            ...
            mm.To.Add(new MailAddress("sp23mis333k.group9@gmail.com"));
